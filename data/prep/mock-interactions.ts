...
// ── RequirementsSorter mock ────────────────────────────────────────────────

export const mockRequirementsSort: RequirementsSortInteraction = {
  ...
  items: [
    ...
    },
    {
      ...
      correctBucket: "functional",
      explanation:
        "The system's primary read operation — it must DO this.",
    },
    {
      id: "r4",
...
// ── EstimationCalculator mock ──────────────────────────────────────────────

export const mockEstimationCalculator: EstimationCalculatorInteraction = {
...
export const mockFlashcardDeck: FlashcardDeckInteraction = {
  type: "flashcard-deck",
...
export const mockTradeoffPicker: TradeoffPickerInteraction = {
...
// ── Assembled interactive prep sections ───────────────────────────────────

export const mockInteractiveSections: InteractivePrepSection[] = [
  {
    type: "interactive",
    ...
    interaction: mockRequirementsSort,
  },
  {
    type: "interactive",
    ...
    interaction: mockEstimationCalculator,
  },
  {
    type: "interactive",
    sectionId: "deepDive",
  ...
  },
  {
    ...
    interaction: mockTradeoffPicker,
  },
];
